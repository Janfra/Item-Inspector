...
public static class MyMathsLibrary
{
    ...
    public static MyVector3 Lerp(MyVector3 startPoint, MyVector3 endPoint, float t)
    {
        return startPoint * (1 - t) + endPoint * t;
    }
...
public class Matrix4By4
{
    ...
    private MyVector4 GetRow(int rowNumber)
    {
    ...
    private MyVector4 GetColumn(int columnNumber)
    {
